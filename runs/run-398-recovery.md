...
claims_added: []
files_modified:
  - runs/run-398-recovery.md
proposals_created: []
completed_at: 2026-07-20T11:58:38Z
status: completed
schema_version: 2.0.0
---

# Run 398 — recovery mode
...
## Action taken
Per vault-protocol recovery rules, no country profiles, sources, claims, verification queue, state, index, changelog, or proposal files were modified by this run. This run wrote only this recovery log so the next iteration has an explicit health record.
