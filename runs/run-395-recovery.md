...
claims_added: []
files_modified:
  - runs/run-395-recovery.md
proposals_created: []
completed_at: 2026-07-20T02:54:25Z
status: completed
schema_version: 2.0.0
---

# Run 395 - recovery log

## Trigger

Pre-flight repository hygiene failed before a normal relocation-vault iteration could start. `git fetch origin` succeeded, but `git status --short` reported a dirty working tree on `main`.
