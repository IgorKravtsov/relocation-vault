...
- **Remote-worker rights/duration/cost**: once granted, the visa gives the right to work remotely from Panama without another state work/residence permit. It is valid for **9 months**, renewable once for the same period, with a card cost of **B/.50** and a B/.250 payment to the National Migration Service listed in the checklist. [src-199]
- **Remote-worker documents**: the checklist includes notarized power/application, photos, notarized/authenticated passport copy, criminal-record certificate, health certificate, sworn personal-background form, application form with return/repatriation undertaking, medical-insurance policy covering Panama, foreign-company existence certificate, employer letter with role/functions/income/payment periodicity/remote modality/repatriation undertaking, and sworn declaration of no local job/service/business activity in Panama. For self-employed applicants, it substitutes proof of the applicant's foreign-registered company and a notarized declaration describing commercial relationships, services, amounts earned, source of funds, and payment periodicity. [src-199]

#### After 4 March 2027

- Panama is outside the EU temporary-protection system, so there is no Ukraine TP bridge to capture. For this couple, Panama must stand on an ordinary Panama route before EU TP expires.
- The remote-worker visa is useful as a legal bridge but is **not** captured as permanent residence and appears in the non-resident / short-stay section of the official permits catalogue. Treat it as a 9+9 month staging route, not the whole long-term plan. [src-198][src-199]
- Potential long-term categories visible in the official catalogue include permanent residence for specific/friendly countries, foreign professional, employee categories, investments, and dependent of permanent resident. This pass did not prove which of these fits a Ukrainian foreign-client IT worker without Panama employment or high investment. [src-198][src-200]
...
- No Panama-specific source was captured on interaction with an existing Polish residence card. Operational baseline: a Polish residence card does not replace Panama entry or status. It may matter as proof of current domicile/residence abroad for tourist/visa applications and could trigger criminal-record or domicile-document requirements from Poland. [src-199][src-201]
...
> **DoD status**: passed at medium confidence. Temperature, clearer-sky day-equivalent proxies, rain/humidity, and household comfort are covered for Panama City, David, and Boquete/Guayabal.

Panama is tropical: the core comfort problem is not winter but heat, humidity, rainfall, and cloudiness. Lowland Panama City and David are warm to hot year-round; Boquete/Guayabal is meaningfully cooler because of elevation but remains humid and rainy. [src-202][src-203]

| City | January average high/low | July average high/low | Clearer-sky day-equivalent proxy | Comfort notes |
|---|---:|---:|---:|---|
| Panama City | ~31.1 / 24.4 C | ~30.6 / 25.0 C | ~83 days/year | Main services/jobs base; no winter, but humidity is muggy/oppressive/miserable about 99% of the year and rainy season is long. [src-202] |
| David | ~31.7 / 22.2 C | ~30.0 / 23.3 C | ~87 days/year | Hot western lowland city near Chiriqui; slightly lower nights than the capital but still muggy most of the year and wetter in rainy months. [src-202] |
| Boquete / Guayabal area | ~27.8 / 17.8 C | ~26.7 / 19.4 C | ~86 days/year | Best climate fit among the three because highland temperatures are milder; still has a long wet/cloudy season and many muggy days. [src-203] |

**Sunny/clear-day method**: WeatherSpark monthly cloud-cover tables report the percentage of time the sky is clear, mostly clear, or partly cloudy. Converted with month lengths, this yields medium-confidence clearer-sky day-equivalent proxies: Panama City ~83, David ~87, and Boquete/Guayabal ~86. These are not official sunny-day counts. [src-202][src-203]
...
- **Can relocate now**: possibly as a remote-worker visa plan if income proof is accepted at/above B/.36,000/year; tourist entry for Ukrainians still needs official-primary country-table confirmation. [src-197][src-199]
- **Best legalization path for the man**: remote-worker short-stay visa as a bridge; then verify friendly-countries, foreign-professional, or another ordinary residence path before committing. [src-198][src-199][src-200]
...
- Do not work for Panama clients/employers on the remote-worker visa; the checklist requires a sworn no-local-work/no-local-business declaration. [src-199]
- File only through a lawyer/notarized power if required by the checklist and track the 9-month validity / renewal timing. [src-199]
...
- Do not treat remote-worker status as enough for the whole long-term plan unless a follow-on residence route is confirmed.

### 6e. Long-term (3-7 years)
- Verify PR timing, citizenship/naturalization timing, absence rules, and dual-nationality consequences before scoring Panama as a passport route. [verification required]

### 6f. Relocation budget (one-time costs)

| Item | USD / EUR | Notes |
|---|---:|---|
| Remote-worker card | B/.50 | Official card cost. [src-199] |
| Remote-worker filing/payment | B/.250 | Payment to National Migration Service listed in checklist. [src-199] |
...
### 7a. Official primary
- [src-198] Panama National Migration Service permits catalogue.
