...
- **Permanent residence**: MFA says a permanent resident card is valid for five years and extendable by another five years. Eligibility includes running business activity in Armenia, being an Armenian national, or a family/relative route tied to an Armenian citizen or special-passport holder with accommodation/property and three years of legal residence. This suggests a business-based long-term ladder may exist, but business-substance and renewal evidence remain to verify. [src-275]
- **Citizenship**: MFA says that, from 1 January 2026, citizenship applications are submitted through the `mcs-citizenship.am` electronic system. A person at least 18 can apply if, among other grounds, they have been permanently and lawfully residing in Armenia for at least three years; other grounds include Armenian descent, marriage to an Armenian citizen with residence conditions, refugee/stateless status, or parent/child links. This is a potentially short naturalization baseline, but exact interpretation of "permanently and lawfully residing" for temporary/permanent business residents must be verified before scoring. [src-276]

#### Polish karta pobytu interaction

A Polish residence card does not replace the need for Armenian entry/residence status. Armenia is outside the EU/Schengen temporary-protection framework, so the EU one-Member-State TP rule is less central than for EU states; however, the couple should still verify whether the Polish status has absence / renewal constraints before relocating. [verification required]
...
Armenia is continental and altitude-sensitive. Climate to Travel describes much of the country as high plateau with freezing winters and relatively warm summers; Yerevan, on the lower western plateau, is arid continental with less cold winters, very hot summers, and low rainfall. [src-277]

| City / area | January baseline | July baseline | Sun / clear-sky proxy | Comfort notes |
|---|---:|---:|---:|---|
| Yerevan | about 18/34°F low/high in climate table; Climate to Travel also summarizes January average near -3°C | about 66/93°F low/high; normal July/August highs around 34–35°C, sometimes 40°C | 2,675 sun hours/year; WeatherSpark clearer-sky proxy ≈255 day-equivalent days/year | Dry and sunny, very low muggy burden, but summer heat is a major comfort risk. [src-277][src-278] |
| Gyumri | about 7/27°F low/high; average January around -8°C | about 55/81°F low/high | 2,395 sun hours/year; WeatherSpark clearer-sky proxy ≈236 day-equivalent days/year | Cooler summers but very cold winters at 1,500 m. [src-277][src-278] |
| Sevan / high plateau | Sevan table about 19/30°F low/high; average January around -4°C | about 57/72°F low/high | 2,700 sun hours/year in Sevan climate table | Pleasant summer refuge but winter remains cold; better as summer climate hedge than default year-round base. [src-277] |
...
- **Can relocate now**: Yes for scouting / first filing, because Ukrainian passport holders have a visa-free baseline; not yet proven as a settlement route.
...
- Use visa-free stay for apartment search, business/tax setup scoping, translations, medical certificate, and residence filing preparation. [src-274][src-275]
- File with the Migration and Citizenship Service route once the residence ground evidence is ready; MFA lists up to 30 days processing after submission. [src-275]
...
### 7a. Official primary
- [src-274] Armenia MFA — visa framework, visa-free list, and bilateral/multilateral visa-free regime list.
- [src-275] Armenia MFA — Temporary and Permanent Residency in Armenia.
