...
| Climate | — | N/A | Very sunny Mediterranean climate, but direct city-level sunny-day counts still [verification required]. | §5.2 |
...
- **Best legalization path for the man**: NRP conceptually fits foreign-client IT work but requires EUR 42,000/year gross and does not lead to PR/citizenship [src-047][src-049].
