...
> First-pass country profile opened in run-025. All content is in English per the vault language rule.
...
**Entry baseline.** Serbia's MFA visa-regime page says Ukrainian ordinary-passport holders do not need a visa for visits up to 90 days within 180 days. That makes Serbia easy to enter for reconnaissance or to submit an in-country application where the route allows it. [src-132]

**Temporary protection for Ukrainians.** Serbia's Government decision grants temporary protection to displaced persons coming from Ukraine, including Ukrainian citizens and family members who resided in Ukraine, some non-Ukrainian protection holders / stateless persons, and some third-country nationals with Ukrainian residence who cannot safely return. The KIRS consolidated text shows the original 2022 decision, rights under Article 76 of the Law on Asylum and Temporary Protection, registration by the Ministry of Interior, and 2023/2024 amendments extending the framework: protection may be extended by one-year periods as long as the reasons for protection continue. [src-133][src-134]
...
The 2023-amended Law on Foreigners provides permanent residence after **3 years** of continuous residence before the PR application, with allowed absences of multiple stays outside Serbia totaling up to 10 months or a single stay up to 6 months over the 3-year period. Student residence cannot itself lead directly to PR; if later changed to another basis, only one-half of student-residence time counts. [src-136]

Serbia's MFA citizenship page says a foreigner with permanent residence may acquire Serbian citizenship if they are 18+, not deprived of business capacity, have been released from foreign citizenship or prove they will be released if admitted, have had registered permanent residence in Serbia for at least 3 uninterrupted years before application, and sign a statement that they consider Serbia their country. The page also says special emigrant/Serbian-people categories do not require release from foreign citizenship, but that exception is probably irrelevant to this Ukrainian couple. [src-138]

First-pass implication: an ordinary route could plausibly be **3 years to PR + 3 years of registered permanent residence to citizenship**, but the citizenship foreign-citizenship-release condition is a major long-term caveat for Ukrainians and needs a later nationality-law pass.
...
- Documents (with apostille / notarized translation markers): valid passports; birth/marriage-status documents; police/background certificate if required for the chosen single-permit route; diplomas/contracts/client agreements; bank statements; health-insurance proof; translations into Serbian where required. [verification required]
...
- Submitting residence application (if not done from abroad): file via MUP/official electronic route for temporary residence or single permit. [src-135][src-136][src-137]
...
- Fallback path if TP transition fails: self-employment / independent professional / property / family route, depending on full verification.

### 6e. Long-term (3–7 years)
- PR: potentially after 3 years continuous temporary residence, subject to absence limits and basis-specific counting. [src-136]
- Citizenship: ordinary route appears to require 3 uninterrupted years of registered permanent residence plus release/proof of release from foreign citizenship; later pass required. [src-138]
...
### 7a. Official primary
- [src-132] Serbia MFA visa-regime page for Ukraine.
- [src-133] KIRS / Serbian official consolidated temporary-protection decision for displaced persons from Ukraine.
- [src-134] Law on Asylum and Temporary Protection.
- [src-135] MUP temporary residence page.
