...
- SDA states that residence for family reunification is issued to family members of an alien holding a residence permit. The required package includes proof of kinship, lawful stay, income or bank funds; money in a personal bank account can count, and the monthly amount should not be less than twice the minimum subsistence level for the average consumer, considering the permit validity term. For this couple, **marriage is the conservative baseline** before relying on derived status; unmarried partner coverage was not confirmed in this pass. [src-157] Confidence: high for family-permit checklist, medium for partner implication.

#### Polish karta pobytu interaction

- A Polish residence card does not substitute for Georgian residence. Georgia is not in the EU/Schengen residence-permit framework; a Polish card may help document lawful residence history or travel logistics, but the couple still needs a Georgian legal-stay basis. If the Polish status is EU temporary protection, it does not create a Georgian protection status. [src-157] Confidence: medium.

#### PR and citizenship

- **Permanent residence**: SDA states that permanent residence is granted to an alien who has lived in Georgia for the last **10 years** based on a temporary residence permit; time for study, medical treatment, and diplomatic/equivalent mission work is excluded. [src-157] Confidence: high.
- **Citizenship**: SDA states that regular naturalization requires lawful residence for the last **10 consecutive years** up to application day, passing tests in Georgian official language, Georgian history, and basic principles of law, and having a job, real estate, business activity, or shares/interest in a Georgian enterprise. [src-158] Confidence: high.

#### Personal playbook for our couple

1. Treat Georgia as easy-entry but **not** as a residence solution by itself: verify the official current Ukraine visa-free stay before travel, and do not assume more than a one-year visa-free baseline until the decree / GeoConsul table is captured. [src-155][src-156]
2. For the male IT worker, prioritize the **IT residence permit** research path: prepare evidence of at least 2 years' IT activity, annual remuneration of at least USD 25,000 equivalent, foreign contracts / employer letters, bank statements, and, if using the entrepreneurial route, Georgian small-business registration evidence. [src-157]
3. If the IT route is not workable, evaluate work/entrepreneur residence only as a real local-business file with turnover / income evidence, not as a simple DN substitute. [src-157]
...
|---|---:|---:|---|---|
| Tbilisi | Jan mean 3.4 C; winter can have snow/cold spells | Jul mean 25.9 C; Aug mean 26.0 C; hot spells above 35 C possible | ~2,045 sunshine hours/year; ~510 mm rain/year over ~71 rain days | Best fit for dry inland sun, but summers are hot and winters are colder than the coast. [src-159] |
| Batumi | Jan mean 7.8 C | Jul mean 23.4 C; Aug mean 24.2 C | ~1,960 sunshine hours/year; very wet, ~2,435 mm/year over ~140 rain days | Mildest winter and seaside option, but humid subtropical climate means frequent rain and muggy summer periods. [src-160] |
...
- **Can relocate now**: likely yes for entry / initial lawful stay, but the current Ukraine visa-free duration must be verified from the official decree or GeoConsul table before relying on it.
...
- If pursuing IT residence, confirm the State Employment Support Agency / work-right registration step and whether the application can be built from foreign-client contracts plus Georgian small-business registration.
...
- Georgia is not an EU TP extension plan. Have a Georgian residence strategy active before relying on Georgia for long-term stay.

### 6e. Long-term (3–7 years)
- Recheck whether the chosen temporary permit type counts toward Georgia's 10-year PR and citizenship clocks before treating Georgia as a settlement destination.

### 6f. Relocation budget (one-time costs)

| Item | USD / EUR | Notes |
|---|---:|---|
| Visa / residence permit fees | — | Fee schedule needs route-specific pass. |
...
### 7a. Official primary
- [src-155] Georgian MFA GeoConsul — Entering Georgia.
