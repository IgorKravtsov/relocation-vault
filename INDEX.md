...
- **Consolidation note**: run-290 added `dimensions/comfort-partner-fit-5.8-5.9.md`, a non-ranking comfort / partner-fit map that groups already captured §5.8/§5.9 baselines into marriage/dependent-path, language/bureaucracy-friction, independent-status-fallback, bridge/status-capped, and high-adaptation-pressure buckets. All 33 countries have assigned screening tiers, but this remains a screening taxonomy, not a TOP-N ranking or final relocation recommendation.
