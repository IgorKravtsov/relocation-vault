...
- **Consolidation note**: runs 291-292 added downstream handoff artifacts (`dimensions/final-synthesis-readiness-checklist.md` and `dimensions/application-prep-trigger-map.md`); run 293 confirmed 0 stale claims and 0 pending/open verification items. All 33 countries have assigned screening tiers, but this remains a screening/handoff taxonomy, not a TOP-N ranking or final relocation recommendation.
