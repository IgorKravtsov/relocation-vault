...
This worksheet is a non-ranking normalization layer between the completed country profiles and schema-safe writes to `tier` fields. As of run-257, it records both the screening-safe bands for countries still awaiting tier application and the small-batch tier changes already applied. It is not a TOP-N ranking or relocation recommendation.
...
| Bridge / high-burden / uncertain-settlement candidate | Cyprus, Croatia, North Macedonia, Bosnia and Herzegovina, Moldova, Mexico, Argentina, UAE, Malaysia, Thailand, Indonesia, Kazakhstan, Armenia | Useful for bridge/base or ordinary-business planning, but the captured route is income-gated, short-term, high-burden, uncertain for remote IT settlement, or weak as a predictable PR/citizenship ladder for the couple's current profile. | Medium-low for final tier; keep final `tier` null until a schema-safe tier application pass writes explicit country rationales, except Cyprus and Croatia now have explicit Tier X screening-negative assignments for the current income profile. |
