...
- Do not treat `tier_hint` as assigned final `tier`; only Greece, Spain, Portugal, Italy, Cyprus, Croatia, and Malta have assigned final tiers after run-258, while all other countries remain null until explicit rationale is written.
