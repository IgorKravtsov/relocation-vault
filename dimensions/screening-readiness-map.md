...
- Verification queue: 0 pending/open items at run-295 trigger recheck; country-local unverified counters are also 0 after reconciliation.
- Staleness queue: 0 stale claims at run-295 trigger recheck.
